...
@Component({
  selector: 'app-tournament-clubs',
  templateUrl: './tournament-clubs.component.html',
  styleUrls: ['./tournament-clubs.component.scss']
})
export class TournamentClubsComponent {
