...
export class routes {
  ...
  public static get registerPlayer(): string {
    return this.baseUrl + '/register-player';
  }
  public static get memberProfile(): string {
    return this.baseUrl + '/club/member-profile';
  }
  public static get registerClub(): string {
    return this.baseUrl + '/register-club';
  }
  ...
  public static get addAppointmentOld(): string {
    return this.baseUrl + '/appointments/add-appointment-old';
  }
  public static get appointmentListOld(): string {
    return this.baseUrl + '/appointments/appointment-list';
  }
  public static get editAppointmentOld(): string {
  ...
  public static get appointmentList(): string {
    return this.baseUrl + '/appointments/list-appointments';
  }
  ...
  public static get appointmentCalendar(): string {
    return this.baseUrl + '/calendar-appoinment/appointments';
  }
  ...
  public static get editDoctor(): string {
    return this.baseUrl + '/doctors/edit-doctor';
  }
  ...
  public static get pagos(): string {
    return this.baseUrl + '/appointments-pay/list';
  }
  ...
  public static get listRole(): string {
    return this.baseUrl + '/roles/list';
  }
  public static get registerSpeciality(): string {
    return this.baseUrl + '/specialities/add-speciality';
  }
  public static get listSpeciality(): string {
    return this.baseUrl + '/specialities/list-speciality';
  }
  public static get addClub(): string {
    return this.baseUrl + '/clubs/add-club';
  }
  public static get clubList(): string {
    return this.baseUrl + '/clubs/list-club';
  }
  public static get addPlayer(): string {
    return this.baseUrl + '/players/add-player';
  }
  public static get playerList(): string {
    return this.baseUrl + '/players/list-player';
  }
  public static get leagueList(): string {
    return this.baseUrl + '/leagues/list-league';
  }
  public static get addLeague(): string {
    return this.baseUrl + '/leagues/add-league';
  }
  public static get categoryList(): string {
    return this.baseUrl + '/categories/list-category';
  }
  public static get addCategory(): string {
    return this.baseUrl + '/categories/add-category';
  }
  public static get teamList(): string {
    return this.baseUrl + '/teams/list-team';
  }
  public static get addTeam(): string {
    return this.baseUrl + '/teams/add-team';
  }
  public static get jorneyList(): string {
    return this.baseUrl + '/jorneys/list-jorney';
  }
  public static get addJorney(): string {
    return this.baseUrl + '/jorneys/add-jorney';
  }

  public static get tournamentList(): string {
    return this.baseUrl + '/tournaments/list-tournament';
  }
  public static get addTournament_old(): string {
    return this.baseUrl + '/tournaments/add-tournament';
  }

  public static get addTournament(): string {
    return this.baseUrl + '/tournament/data';
  }

  
  public static get courtsList(): string {
    return this.baseUrl + '/courts/list-courts';
  }
 

  public static get courtCalendar(): string {
    return this.baseUrl + '/reservations/calendar';
  }

  public static get todayReservations(): string {
    let pipe = new DatePipe('en-US');
    let today = new Date();
    let date = pipe.transform(today, 'yyyy-MM-dd');
    return this.baseUrl + '/reservations/new/' + date; 
  }

  public static get todayReservationsWithoutDate(): string {
    return this.baseUrl + '/reservations/new'; 
  }

  public static get listRecurrent(): string {
    return this.baseUrl + '/recurrents/list';
  }
  public static get addRecurrent(): string {
    return this.baseUrl + '/recurrents/book-recurrent';
  }

  public static get listLesson(): string {
    return this.baseUrl + '/lessons/list';
  }
  public static get addLesson(): string {
    return this.baseUrl + '/lessons/book-lesson';
  }

  public static get courtReservation(): string {
    return this.baseUrl + '/reservations/new';
  }
  public static get club(): string {
    return this.baseUrl + '/club/data';
  }
  public static get playerData(): string {
    return this.baseUrl + '/player/data';
  }
  public static get playerMatch(): string {
    return this.baseUrl + '/player/match';
  }
  public static get playerWallet(): string {
    return this.baseUrl + '/player/wallet';
  }
  public static get playerClubs(): string {
    return this.baseUrl + '/player/clubs';
  }
  public static get otherClubs(): string {
    return this.baseUrl + '/player/other-clubs';
  }
  public static get clubSchedule(): string {
    return this.baseUrl + '/club/schedule';
  }
  public static get description(): string {
    return this.baseUrl + '/club/description';
  }
  public static get clubCourts(): string {
    return this.baseUrl + '/club/courts';
  }
  public static get clubServices(): string {
    return this.baseUrl + '/club/services';
  }
  public static get clubSocialLinks(): string {
    return this.baseUrl + '/club/social-links';
  }
  public static get addCourt(): string {
    return this.baseUrl + '/club/courts/add-court';
  }
  public static get editCourt(): string {
    return this.baseUrl + '/edit';
  }
  public static get booking(): string {
    return this.baseUrl + '/club/:id/booking';
  }

  public static get categoryData(): string {
    return this.baseUrl + '/category/data/:id';
  }
  public static get categoryCouples(): string {
    return this.baseUrl + '/category/couples';
  }
  public static get categoryJourneys(): string {
    return this.baseUrl + '/category/journeys';
  }
  public static get categoryRanking(): string {
    return this.baseUrl + '/category/ranking';
  }

  public static get monitorList(): string {
    return this.baseUrl + '/monitors/list-monitor';
  }
  public static get addMonitor(): string {
    return this.baseUrl + '/monitors/add-monitor';
  }

  public static get walletList(): string {
    return this.baseUrl + '/wallet/list-wallet';
  }
  public static get addWallet(): string {
    return this.baseUrl + '/wallet/add-wallet';
  }

  public static get memberList(): string {
    return this.baseUrl + '/members/list-member';
  }
  public static get addMember(): string {
    return this.baseUrl + '/members/add-member';
  }
  
  public static get getSubscription(): string {
    return this.baseUrl + '/subscriptions/get-subscription';
  }
  public static get getPayments(): string {
    return this.baseUrl + '/payments/get-payments';
  }
  public static get paymentView(): string {
    return this.baseUrl + '/payments/view-payments';
  }

  public static get emailSentList(): string {
    return this.baseUrl + '/emails/sent';
  }

  public static get sendNewEmail(): string {
    return this.baseUrl + '/emails/new';
  }

  public static get AddPotentialClub(): string {
    return this.baseUrl + '/emails/potential-club';
  }

  public static get ListPotentialClubs(): string {
    return this.baseUrl + '/emails/list';
  }
  ...
  public static get urbanisationsList(): string {
    return this.baseUrl + '/urbanisation/list';
  }

  public static get addUrbanisations(): string {
    return this.baseUrl + '/urbanisation/add';
  }

  public static get owners(): string {
    return this.baseUrl + '/owner/list';
  }

  public static get meetingList(): string {
    return this.baseUrl + '/meeting/list';
  }

  public static get addMeeting(): string {
    return this.baseUrl + '/meeting/add';
  }

  public static get questionList(): string {
    return this.baseUrl + '/members/list-member';
  }

  public static get addQuestion(): string {
    return this.baseUrl + '/members/add-member';
  }
