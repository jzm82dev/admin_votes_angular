...
@Component({
  selector: 'app-edit-urbanisation',
  templateUrl: './edit-urbanisation.component.html',
  styleUrls: ['./edit-urbanisation.component.scss']
})
export class EditUrbanisationComponent {
    ...
    ngOnInit(): void {
      ...
      this.activateRoute.params.subscribe( (resp:any) => {
        this.urbanisation_id = resp.id;
        this.getUrbanisation();
      });
    ...
    getUrbanisation(){
      ...
      this.urbanisationSrv.getUrbanisation(this.urbanisation_id).subscribe( (resp:any) => {
        this.urbanisation_selected = resp.urbanisation;
        this.name = this.urbanisation_selected.name;
        this.president = this.urbanisation_selected.president;
        ...
        this.countrySelected(this.country_id);
        this.state_id = this.urbanisation_selected.state_id;
        this.stateSelected(this.state_id);
        this.city_id = this.urbanisation_selected.city_id;
        this.postal_code = this.urbanisation_selected.postal_code;
        this.isLoaded = true;
      });
  ...
  saveData(){
    ...
    this.urbanisationSrv.updateUrbanisation(this.urbanisation_id, formData).subscribe( (resp: any) => {
      if( resp.message == 200){
