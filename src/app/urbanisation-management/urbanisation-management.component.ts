...
@Component({
  selector: 'app-urbanisation-management',
  templateUrl: './urbanisation-management.component.html',
  styleUrls: ['./urbanisation-management.component.scss']
})


export class UrbanisationManagementComponent {
