...
@Component({
  selector: 'app-view-back-draw',
  templateUrl: './view-back-draw.component.html',
  styleUrls: ['./view-back-draw.component.scss']
})


export class ViewBackDrawComponent {
  ...
  getDraw(category_id: string, type_draw: string){
    ...
    this.categorySrv.totalCouplesCategory(category_id).subscribe( (resp:any) => {
      ...
      this.tournamentSrv.getDraw(this.category_id, 'back').subscribe((resp:any) => {
        this.data = resp;
